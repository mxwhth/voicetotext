...
/**
 * A fragment representing a single Template detail screen.
 * This fragment is either contained in a {@link TemplateListActivity}
 * in two-pane mode (on tablets) or a {@link TemplateDetailActivity}
 * on handsets.
 */
public class TemplateDetailFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        if (mItem != null) {
            ((TextView) rootView.findViewById(R.id.template_detail)).setText(mItem.details);
        }
